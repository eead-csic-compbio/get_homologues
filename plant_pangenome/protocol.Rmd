...
As assembled transcripts are often incomplete, as well as gene models, by default GET_HOMOLOGUES-EST computes alignment coverage with respect to the shortest sequence, as illustrated on __Figure 5__. Users can add the 'flcdna' string to input FASTA filenames to indicate that coverage should be computed with respect to full-length cDNA sequences, when available. 
