...
2) Li L, Stoeckert CJ Jr, Roos DS (2003) OrthoMCL: identification of ortholog 
groups for eukaryotic genomes. Genome Res. 13(9):2178-89.

3) Kristensen DM, Kannan L, Coleman MK, Wolf YI, Sorokin A, Koonin EV, 
...
4) Altschul SF, Madden TL, Schaffer AA, Zhang J, Zhang Z, Miller W and Lipman DJ 
(1997) Gapped BLAST and PSI-BLAST: a new generation of protein database search 
programs. Nucl. Acids Res. 25(17): 3389-3402. 

5) Stajich JE, Block D, Boulez K, Brenner SE, Chervitz SA, Dagdigian C, Fuellen G, 
...
6) hmmscan :: search sequence(s) against a profile database HMMER 3.0 (March 2010) 
http://hmmer.org Copyright (C) 2010 Howard Hughes Medical Institute.
Freely distributed under the GNU General Public License (GPLv3).

7) Finn RD, Bateman A, Clements J, Coggill P, Eberhardt RY, Eddy SR, Heger A, 
...
8) Felsenstein, J. 2005. PHYLIP (Phylogeny Inference Package) version 3.6. Distributed 
by the author. Department of Genome Sciences, University of Washington, Seattle.

9) Haas BJ, Papanicolaou A, Yassour M et al. (2013) De novo transcript sequence 
