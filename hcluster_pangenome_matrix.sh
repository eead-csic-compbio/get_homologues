...
progname=${0##*/} 
VERSION='v1.2_5Jan20' # v1.3_7Jan10: 
...
function print_help()
{
    ...
    EXAMPLE:
      $progname -i pangenome_matrix_t0.tab -t "Pan-genome tree" -a ward.D2 -d gower -o pdf -x 'maltoph|genosp' -A '35,NULL' -X 0.8 -k 50 -P inferno
