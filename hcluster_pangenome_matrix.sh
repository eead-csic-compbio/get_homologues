...
progname=${0##*/} 
VERSION='v2.4_20Apr20,' # fixed warning ‘mode(height)’ differs between new and previous, install instructions for all modules 
...
function print_notes()
{
   cat << NOTES
    ...
    i) with root privileges, type the following into your shell console:
       sudo R
       > install.packages(c("ape","gplots","cluster","grDevices","dendextend","factoextra","RColorBrewer","viridis"), dependencies=TRUE)
       > q()
    ...
    ii) without root privileges, intall the package into ~/lib/R as follows:
       ...
       > install.packages(c("ape","gplots","cluster","grDevices","dendextend","factoextra","RColorBrewer","viridis"), dependencies=TRUE, lib="~/lib/R")
